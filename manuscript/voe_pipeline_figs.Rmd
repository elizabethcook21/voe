...
for(p in phenotypes){
  ...
  write.csv(confounder_analysis_list,paste('figures/corplot_',strsplit(f,'.csv')[[1]][[1]],sep=''))
  pdf(paste('figures/corplot_',strsplit(f,'.rds')[[1]][[1]],'.pdf',sep=''),width=3,height=3)
  pheatmap(cor(confounder_analysis_list),cluster_rows=FALSE,cluster_cols=FALSE,main = p,breaks=breaksList)
  dev.off()
}
